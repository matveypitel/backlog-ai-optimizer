...
public class OpenAiSettings
{
    ...
    public double CoverageGapThreshold { get; init; } = 0.55;
    public int ReprioritizationSimilarFeaturesTopN { get; init; } = 10;
    public double ReprioritizationSimilarityThreshold { get; init; } = 0.68;
